...
(function() {
  ...
  Card = (function() {
    ...
    function Card(opts) {
      this.maskCVC = bind(this.maskCVC, this);
    ...
    Card.prototype.attachHandlers = function() {
      var cvcInputFilters, expiryFilters, numberInputFilters;
      numberInputFilters = [this.validToggler('cardNumber')];
      if (this.options.masks.cardNumber) {
        numberInputFilters.push(this.maskCardNumber);
      }
      cvcInputFilters = [this.validToggler('cardCVC')];
      if (this.options.masks.cardCVC) {
        cvcInputFilters.push(this.maskCVC);
      }
    ...
    Card.prototype.maskCVC = function(val, el, out) {
      var mask, numbers;
